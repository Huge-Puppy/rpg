...
public class AttackController : MonoBehaviour
{
    ...
    [SerializeField] FloatVariable currentMagic;
    ...
    void Start()
    {
        currentEnemyHealth = currentEnemy.value.maxHealth;
        currentEnemyMagic = currentEnemy.value.maxMagic;
        playerSignal.Raise();
    }
    ...
    {
        float damage = Mathf.Ceil(currentEnemy.value.strength);
